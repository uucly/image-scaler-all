...
namespace ImageScalerCSharp.Controllers
{
    public class ImageScalerService
    {
        ...
        /*public Bitmap Resize(Image image, int width, int height)
        {
            ...
            var imageGraphic = Graphics.FromImage(image);
            destImage.SetResolution(imageGraphic.DpiX, imageGraphic.DpiY);
        ...
        public Image FixedSize(Image imgPhoto, int Width, int Height)
        {
            ...
            var imageGraphic = Graphics.FromImage(imgPhoto);

            bmPhoto.SetResolution(imageGraphic.DpiX,
                             imageGraphic.DpiY);
